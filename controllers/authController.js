...
const { passwordResetTemplate } = require("../utils/emailTemplate.js");
...
const forgotPassword = async (req, res) => {
  ...
  try {
    ...
    const html = passwordResetTemplate(user.username, resetLink);

    await sendEmail(user.email, "Password Reset - Le-Travaille", html);
